...
| 技能 | 描述 |
|-------|-------------|
| [**antigravity-cli**](/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-antigravity-cli) | 操作 Antigravity CLI（agy）：插件、认证、沙箱。 |
...
| [**openhands**](/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-openhands) | 将编码任务委托给 OpenHands CLI（模型无关，LiteLLM）。 |
...
| 技能 | 描述 |
|-------|-------------|
| [**baoyu-article-illustrator**](/user-guide/skills/optional/creative/creative-baoyu-article-illustrator) | 文章插图：类型 × 风格 × 调色板一致性。 |
| [**baoyu-comic**](/user-guide/skills/optional/creative/creative-baoyu-comic) | 知识漫画（知识漫画）：教育、传记、教程。 |
| [**blender-mcp**](/user-guide/skills/optional/creative/creative-blender-mcp) | 通过目录中的 blender MCP 驱动 Blender，使用 bpy 配方。 |
...
| [**creative-ideation**](/user-guide/skills/optional/creative/creative-creative-ideation) | 通过创意实践中的命名方法生成创意。 |
...
| [**pixel-art**](/user-guide/skills/optional/creative/creative-pixel-art) | 像素艺术，配备复古调色板（NES、Game Boy、PICO-8）。 |
...
| [**hermes-s6-container-supervision**](/user-guide/skills/optional/devops/devops-hermes-s6-container-supervision) | 修改、调试或扩展 Hermes Agent Docker 镜像内部的 s6-overlay 监督树 — 添加新服务、调试配置文件网关、理解 Architecture B 主程序模式。 |
...
| 技能 | 描述 |
|-------|-------------|
| [**adversarial-ux-test**](/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test) | 扮演产品中最难应对、技术抵触型用户。以该角色浏览应用，找出所有 UX 痛点，再通过实用主义过滤层区分真实问题与噪音，生成可执行的工单。 |
...
| 技能 | 描述 |
|-------|-------------|
| [**minecraft-modpack-server**](/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server) | 托管 Modded Minecraft 服务器（CurseForge、Modrinth）。 |
| [**pokemon-player**](/user-guide/skills/optional/gaming/gaming-pokemon-player) | 通过无头模拟器 + RAM 读取玩宝可梦。 |
...
| [**dspy**](/user-guide/skills/optional/mlops/mlops-research-dspy) | DSPy：声明式 LM 程序、自动优化 prompt、RAG。 |
...
| [**obliteratus**](/user-guide/skills/optional/mlops/mlops-obliteratus) | OBLITERATUS：基于 diff-in-means 的 LLM 拒答消除。 |
...
| 技能 | 描述 |
|-------|-------------|
| [**mpp-agent**](/user-guide/skills/optional/payments/payments-mpp-agent) | 通过机器支付协议（MPP）支付 HTTP 402 API。 |
| [**stripe-link-cli**](/user-guide/skills/optional/payments/payments-stripe-link-cli) | 通过 Stripe Link 实现 agent 支付 — 卡片、SPT、审批。 |
...
| [**shop**](/user-guide/skills/optional/productivity/productivity-shop) | 商城目录搜索、结账、订单跟踪、退货。 |
...
| 技能 | 描述 |
|-------|-------------|
| [**bioinformatics**](/user-guide/skills/optional/research/research-bioinformatics) | 通往 bioSkills 和 ClawBio 中 400+ 生物信息学技能的入口。涵盖基因组学、转录组学、单细胞、变异检测、药物基因组学、宏基因组学、结构生物学等领域，按需获取领域特定参考资料。 |
...
| [**web-pentest**](/user-guide/skills/optional/security/security-web-pentest) | 授权的 Web 应用渗透测试 — 侦察、漏洞分析、基于证明的利用及专业报告。采用 Shannon 的"No Exploit, No Report"方法论，配备严格的范围、授权及安全护栏。 |

## software-development

| 技能 | 描述 |
|-------|-------------|
| [**code-wiki**](/user-guide/skills/optional/software-development/software-development-code-wiki) | 为任何代码库生成 Wiki 文档 + Mermaid 图表。 |
...
| [**subagent-driven-development**](/user-guide/skills/optional/software-development/software-development-subagent-driven-development) | 通过 delegate_task 子 agent 执行计划（两阶段审查）。 |
